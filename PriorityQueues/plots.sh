...
plot "$DATADIR/simple_heap_test.data" using (log(\$1)/log(2)):2 title "Binary Heap",\
     "$DATADIR/simple_heap_test.data" using (log(\$1)/log(2)):(6.25*10**(-9)*log(\$1)/log(2)-0.5*10**(-9)) title "6.25*10^{-9}*log(n)", \
     "$DATADIR/simple_heap_test.data" using (log(\$1)/log(2)):(11.5*10**(-9)*log(\$1)/log(2)-80*10**(-9)) title "12.5*10^{-9}*log(n)"
...
plot "$DATADIR/sanders_heap4_test.data" using (log(\$1)/log(2)):2 title "Bottom up aligned 4-ary Heap",\
     "$DATADIR/sanders_heap4_test.data" using (log(\$1)/log(2)):(4.0*10**(-9)*log(\$1)/log(2)+15*10**(-9)) title "4*10^{-9}*log(n)", \
     "$DATADIR/sanders_heap4_test.data" using (log(\$1)/log(2)):(7.2*10**(-9)*log(\$1)/log(2)-3.5*10**(-8)) title "7.2*10^{-9}*log(n)"
...
plot "$DATADIR/sanders_knheap_test.data" using (log(\$1)/log(2)):2 title "Kn Heap", \
     "$DATADIR/sanders_knheap_test.data" using (log(\$1)/log(2)):(2.5*10**(-9)*log(\$1)/log(2)+30*10**(-9)) title "2.5*10^{-9}*log(n)"
