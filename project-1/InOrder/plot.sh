...
plot "$DATADIR/inOrder_O3_constant_alpha.data" using (log(\$1)/log(2)):(\$2) title "Alpha = 0.25"
GPLOT
...
plot "$DATADIR/inOrder_O3_constant_alpha.data" using (log(\$1)/log(2)):(\$3/(log(\$1)/log(2))) title "Alpha = 0.25"
GPLOT
...
plot "$DATADIR/inOrder_O3_constant_alpha.data" using (log(\$1)/log(2)):4 title "L1 Cache", \
     "$DATADIR/inOrder_O3_constant_alpha.data" using (log(\$1)/log(2)):5 title "L2 Cache"
GPLOT
