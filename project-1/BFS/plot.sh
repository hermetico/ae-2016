...
plot "$DATADIR/bfs_O3_vector_test1.data" using (log(\$1)/log(2)):2 title "BFS -O3", \
     "$DATADIR/bfs_vector_test1.data" using (log(\$1)/log(2)):2 title "BFS"
GPLOT
...
plot "$DATADIR/bfs_O3_vector_test1.data" using (log(\$1)/log(2)):(\$3/(log(\$1)/log(2))) title "BFS -O3", \
     "$DATADIR/bfs_vector_test1.data" using (log(\$1)/log(2)):(\$3/(log(\$1)/log(2))) title "BFS"
GPLOT
...
plot "$DATADIR/bfs_O3_vector_test1.data" using (log(\$1)/log(2)):4 title "BFS -O3: L1 Cache", \
     ...
     "$DATADIR/bfs_vector_test1.data" using (log(\$1)/log(2)):4 title "BFS: L1 Cache", \
     "$DATADIR/bfs_vector_test1.data" using (log(\$1)/log(2)):5 title "BFS: L2 Cache"
GPLOT
